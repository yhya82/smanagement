                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 text-right">
                            <a href="{{ route('registrar.applications.show', $application) }}" wire:navigate
                                class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-6 text-center text-gray-500 dark:text-gray-400">No applications yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
