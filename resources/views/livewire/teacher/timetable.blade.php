<div>
    ...
    @elseif ($periods->isEmpty() || $entries->isEmpty())
        <p class="text-sm text-gray-500 dark:text-gray-400">No timetable slots have been scheduled for you yet.</p>
    @else
                            ...
                            @foreach ($days as $day)
                                ...
                                <td class="px-4 py-2 align-top">
                                    @if ($entry)
                                        ...
                                        <div class="text-xs text-gray-400 dark:text-gray-500">{{ $entry->schoolClass->name }}</div>
                                    @else
